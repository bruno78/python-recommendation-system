...
# Swap the rows and columns of products_features just so it's easier to work with
M = np.transpose(M)
...
# The mains logic for finding similar movies:
...
# Note: We ommit the first one because the first one is it's movie itself. 
